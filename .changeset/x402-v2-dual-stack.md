...
New exports from `@a2x/sdk/x402`: `X402_FOUNDATION_EXTENSION_URI`, `X402_EXTENSION_URIS`, `X402_SUPPORTED_VERSIONS`, `X402_DEFAULT_GENERATION`, `detectGeneration`, `isSupportedVersion`, `x402PinnedGeneration`, `isX402ExtensionUri`, and the V1/V2 requirement/payload/response type variants. `X402ContextOptions` gains `defaultGeneration`; `X402StoreEntry` gains `offeredGeneration`.

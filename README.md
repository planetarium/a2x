...
- **Shared x402 merchant policy** — Optional `@a2x/sdk/x402-merchant` gate for hosts that want reusable pricing, metering, frozen offer terms, and one-shot execution claims without coupling the SDK to `AgentEvent`s or hard-coded rates.
